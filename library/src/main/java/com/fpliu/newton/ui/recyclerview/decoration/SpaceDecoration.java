...
public class SpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpaceDecoration(int space, boolean paddingStart) {
        this.space = space;
        this.mPaddingStart = paddingStart;
    }

    public SpaceDecoration(int space, boolean paddingStart, boolean paddingEdgeSide) {
        this.space = space;
        this.mPaddingStart = paddingStart;
        this.mPaddingEdgeSide = paddingEdgeSide;
    }

    public SpaceDecoration(int space, boolean paddingStart, boolean paddingEdgeSide, boolean paddingHeaderFooter) {
        this.space = space;
        this.mPaddingStart = paddingStart;
        this.mPaddingEdgeSide = paddingEdgeSide;
        this.mPaddingHeaderFooter = paddingHeaderFooter;
    }
